CREATE TYPE "public"."hold_outline_kind" AS ENUM('silhouette', 'led_inner');--> statement-breakpoint
CREATE TABLE "hold_outline_overrides" (
	...
	"kind" "hold_outline_kind" DEFAULT 'silhouette' NOT NULL,
...
CREATE UNIQUE INDEX "hold_outline_overrides_placement_idx" ON "hold_outline_overrides" USING btree ("board_name","layout_id","size_id","placement_id","kind");--> statement-breakpoint
