...
CREATE SEQUENCE "public"."spray_hold_catalog_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 1 CACHE 1;--> statement-breakpoint
CREATE SEQUENCE "public"."spray_wall_catalog_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 1 CACHE 1;--> statement-breakpoint
...
ALTER TABLE "spray_climb_lineage" ADD CONSTRAINT "spray_climb_lineage_wall_version_id_spray_wall_versions_id_fk" FOREIGN KEY ("wall_version_id") REFERENCES "public"."spray_wall_versions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "spray_wall_holds" ADD CONSTRAINT "spray_wall_holds_removed_version_id_spray_wall_versions_id_fk" FOREIGN KEY ("removed_version_id") REFERENCES "public"."spray_wall_versions"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "spray_walls" ADD CONSTRAINT "spray_walls_board_uuid_user_boards_uuid_fk" FOREIGN KEY ("board_uuid") REFERENCES "public"."user_boards"("uuid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
