...
const documents: Documents = {
  ...
  '\n  query GetActivityFeed($input: ActivityFeedInput) {\n    activityFeed(input: $input) {\n      items {\n        id\n        type\n        entityType\n        entityId\n        boardUuid\n        actorId\n        actorDisplayName\n        actorAvatarUrl\n        climbName\n        climbUuid\n        boardType\n        layoutId\n        gradeName\n        status\n        angle\n        frames\n        setterUsername\n        commentBody\n        isMirror\n        isBenchmark\n        isNoMatch\n        difficulty\n        difficultyName\n        quality\n        attemptCount\n        comment\n        commentCount\n        createdAt\n      }\n      cursor\n      hasMore\n    }\n  }\n':
    types.GetActivityFeedDocument,
  '\n  fragment SessionFeedItemFields on SessionFeedItem {\n    sessionId\n    sessionType\n    sessionName\n    ownerUserId\n    participants {\n      userId\n      displayName\n      avatarUrl\n      sends\n      flashes\n      attempts\n    }\n    totalSends\n    totalFlashes\n    totalAttempts\n    tickCount\n    gradeDistribution {\n      grade\n      flash\n      send\n      attempt\n    }\n    boardTypes\n    hardestGrade\n    firstTickAt\n    lastTickAt\n    durationMinutes\n    goal\n    notes\n    upvotes\n    downvotes\n    voteScore\n    commentCount\n    hardestSend {\n      uuid\n      userId\n      climbUuid\n      climbName\n      boardType\n      layoutId\n      renderBoard {\n        layoutId\n        sizeId\n        setIds\n      }\n      angle\n      status\n      attemptCount\n      difficulty\n      difficultyName\n      boardseshDifficulty\n      boardseshConfidence\n      quality\n      isMirror\n      isBenchmark\n      isNoMatch\n      comment\n      frames\n      setterUsername\n      climbedAt\n    }\n    featuredBeta {\n      tick {\n        uuid\n        userId\n        climbUuid\n        climbName\n        boardType\n        layoutId\n        renderBoard {\n          layoutId\n          sizeId\n          setIds\n        }\n        angle\n        status\n        attemptCount\n        difficulty\n        difficultyName\n        boardseshDifficulty\n        boardseshConfidence\n        quality\n        isMirror\n        isBenchmark\n        isNoMatch\n        comment\n        frames\n        setterUsername\n        climbedAt\n      }\n      betaLink {\n        climbUuid\n        link\n        foreignUsername\n        angle\n        thumbnail\n        isListed\n        createdAt\n        tickUuid\n        boardId\n      }\n    }\n    socialEntityType\n    socialEntityId\n  }\n':
    types.SessionFeedItemFieldsFragmentDoc,
  '\n  query GetSessionGroupedFeed($input: ActivityFeedInput) {\n    sessionGroupedFeed(input: $input) {\n      sessions {\n        ...SessionFeedItemFields\n      }\n      cursor\n      hasMore\n    }\n  }\n  \n':
    types.GetSessionGroupedFeedDocument,
  '\n  fragment CrewClimbFields on ActivityFeedItem {\n    id\n    type\n    entityType\n    entityId\n    actorId\n    actorDisplayName\n    actorAvatarUrl\n    climbUuid\n    climbName\n    boardType\n    layoutId\n    setterUsername\n    frames\n    description\n    framesPace\n    angle\n    difficultyName\n    ascensionistCount\n    qualityAverage\n    isBenchmark\n    isNoMatch\n    createdAt\n    renderBoard {\n      layoutId\n      sizeId\n      setIds\n    }\n  }\n':
    types.CrewClimbFieldsFragmentDoc,
  '\n  query GetCrewFeed($input: CrewFeedInput) {\n    crewFeed(input: $input) {\n      items {\n        __typename\n        ... on CrewSessionItem {\n          id\n          occurredAt\n          session {\n            ...SessionFeedItemFields\n          }\n        }\n        ... on CrewClimbItem {\n          id\n          occurredAt\n          climb {\n            ...CrewClimbFields\n          }\n        }\n        ... on CrewClimbGroupItem {\n          id\n          occurredAt\n          totalCount\n          climbs {\n            ...CrewClimbFields\n          }\n        }\n      }\n      cursor\n      hasMore\n    }\n  }\n  \n  \n':
    types.GetCrewFeedDocument,
  '\n  query GetSessionDetail($sessionId: ID!) {\n    sessionDetail(sessionId: $sessionId) {\n      sessionId\n      sessionType\n      sessionName\n      ownerUserId\n      participants {\n        userId\n        displayName\n        avatarUrl\n        sends\n        flashes\n        attempts\n      }\n      totalSends\n      totalFlashes\n      totalAttempts\n      tickCount\n      gradeDistribution {\n        grade\n        flash\n        send\n        attempt\n      }\n      boardTypes\n      hardestGrade\n      firstTickAt\n      lastTickAt\n      durationMinutes\n      goal\n      notes\n      upvotes\n      downvotes\n      voteScore\n      commentCount\n      healthKitWorkoutId\n      ticks {\n        uuid\n        userId\n        climbUuid\n        climbName\n        boardType\n        layoutId\n        renderBoard {\n          layoutId\n          sizeId\n          setIds\n        }\n        angle\n        status\n        attemptCount\n        difficulty\n        difficultyName\n        boardseshDifficulty\n        boardseshConfidence\n        quality\n        isMirror\n        isBenchmark\n        isNoMatch\n        comment\n        frames\n        setterUsername\n        climbedAt\n        upvotes\n        totalAttempts\n        betaLinks {\n          climbUuid\n          link\n          foreignUsername\n          angle\n          thumbnail\n          isListed\n          createdAt\n          tickUuid\n          # boardId is kept for BetaLinksGqlRow type parity and flows through\n          # dedupeBetaLinks — it is not displayed by the session-detail carousel.\n          boardId\n        }\n      }\n    }\n  }\n':
  ...
  '\n  query GetNotificationActors($input: NotificationActorsInput!) {\n    notificationActors(input: $input) {\n      users {\n        id\n        displayName\n        avatarUrl\n        followerCount\n        followingCount\n        isFollowedByMe\n      }\n      totalCount\n      hasMore\n    }\n  }\n':
    types.GetNotificationActorsDocument,
  '\n  mutation MarkNotificationRead($notificationUuid: ID!) {\n    markNotificationRead(notificationUuid: $notificationUuid)\n  }\n':
  ...
  '\n  mutation ResolveProposalFeed($input: ResolveProposalInput!) {\n    resolveProposal(input: $input) {\n      uuid\n      climbUuid\n      boardType\n      angle\n      proposerId\n      proposerDisplayName\n      proposerAvatarUrl\n      type\n      proposedValue\n      currentValue\n      status\n      reason\n      resolvedAt\n      resolvedBy\n      createdAt\n      weightedUpvotes\n      weightedDownvotes\n      requiredUpvotes\n      userVote\n      climbName\n      frames\n      layoutId\n      climbSetterUsername\n      climbDifficulty\n      climbQualityAverage\n      climbAscensionistCount\n      climbDifficultyError\n      climbBenchmarkDifficulty\n      climbIsNoMatch\n      upvoterCount\n      commentCount\n      climbIsHidden\n    }\n  }\n':
    types.ResolveProposalFeedDocument,
  '\n  query QaPreviews($prNumbers: [Int!]!, $includeBuilding: Boolean) {\n    qaPreviews(prNumbers: $prNumbers, includeBuilding: $includeBuilding) {\n      prNumber\n      branch\n      title\n      url\n      author\n      isDraft\n      headSha\n      headCommittedAt\n      updatedAt\n      risk\n      riskReason\n      testPlan\n      testPlanSteps\n      otaBuild\n      labels {\n        name\n        color\n      }\n      myLatestVerdict {\n        id\n        prNumber\n        branch\n        verdict\n        comment\n        headSha\n        createdAt\n        githubCommentUrl\n      }\n    }\n  }\n':
  ...
  '\n  query TickBoardOptions($tickUuid: ID!, $limit: Int, $offset: Int) {\n    tickBoardOptions(tickUuid: $tickUuid, limit: $limit, offset: $offset) {\n      currentBoard {\n        uuid\n        name\n        boardType\n        layoutId\n        sizeId\n        setIds\n      }\n      boards {\n        uuid\n        name\n        boardType\n        layoutId\n        sizeId\n        setIds\n      }\n      totalCount\n      hasMore\n    }\n  }\n':
    types.TickBoardOptionsDocument,
};
