...
type BoardPageGridViewProps = ParsedBoardRouteParameters & {
  boardDetails: BoardDetails;
  initialClimbs: Climb[];
};

const BoardPageGridView = ({
  boardDetails,
  initialClimbs,
  board_name,
  layout_id,
  ...
  return (
    <ClimbsListShell
      ...
      showBottomSpacer
    >
      {(contentProps) => <GridViewContent {...contentProps} />}
    </ClimbsListShell>
  );
};

export default BoardPageGridView;
