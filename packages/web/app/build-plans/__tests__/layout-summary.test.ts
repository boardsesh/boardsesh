...
describe('readLayoutSummary', () => {
  it('pulls every summary number out of a generator response', () => {
    expect(readLayoutSummary(GENERATOR_LAYOUT)).toEqual({
      ...
      panelCount: 4,
      panels: [
        { index: 0, id: null, role: null, widthMm: null, heightMm: null },
        { index: 1, id: null, role: null, widthMm: null, heightMm: null },
        { index: 2, id: null, role: null, widthMm: null, heightMm: null },
        { index: 3, id: null, role: null, widthMm: null, heightMm: null },
      ],
      sheets: 6,
      tnutCount: 812,
      ledCount: 411,
