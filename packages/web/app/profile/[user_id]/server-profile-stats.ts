...
// BOARD_TYPES, not the board-picker list this used to read: the SSR prefetch and
// the client hook must fan out over the SAME boards, or first paint is missing
// the ascents the client then fetches and the totals jump on hydration. See the
// note on BOARD_TYPES — ticks exist regardless of what a picker offers.
