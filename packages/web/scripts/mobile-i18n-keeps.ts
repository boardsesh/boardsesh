...
// i18n-keep common.mobile.settings.sessionSection
// i18n-keep common.mobile.settings.notificationsSection
// i18n-keep common.mobile.settings.appearanceSection
// i18n-keep common.mobile.settings.themeSection
// i18n-keep common.mobile.settings.accountSection
// i18n-keep common.mobile.settings.aboutSection
// i18n-keep common.mobile.settings.autoConnectBle
// i18n-keep common.mobile.settings.keepScreenAwake
// i18n-keep common.mobile.settings.hapticFeedback
// i18n-keep common.mobile.settings.sessionInvites
// i18n-keep common.mobile.settings.climbComments
// i18n-keep common.mobile.settings.themeSystem
// i18n-keep common.mobile.settings.themeLight
// i18n-keep common.mobile.settings.themeDark
// i18n-keep common.mobile.settings.version
// i18n-keep common.mobile.settings.signOut
// i18n-keep common.mobile.settings.cancel
// i18n-keep common.mobile.settings.signOutConfirmTitle
// i18n-keep common.mobile.settings.signOutConfirmMessage
// i18n-keep common.mobile.settings.signOutPendingMessage_one
// i18n-keep common.mobile.settings.signOutPendingMessage_other
// i18n-keep common.mobile.settings.boardDataSection
// i18n-keep common.mobile.settings.boardDataNote
// i18n-keep common.mobile.settings.boardSyncEnableTitle
// i18n-keep common.mobile.settings.boardSyncEnableMessage
// i18n-keep common.mobile.settings.boardSyncEnableConfirm
// i18n-keep common.mobile.settings.boardSyncStatusLabel
// i18n-keep common.mobile.settings.boardSyncStatusOff
// i18n-keep common.mobile.settings.boardSyncNotSyncedYet
// i18n-keep common.mobile.settings.boardSyncLastSynced_one
// i18n-keep common.mobile.settings.boardSyncLastSynced_other
// i18n-keep common.mobile.settings.boardSyncProgressClimbs_one
// i18n-keep common.mobile.settings.boardSyncProgressClimbs_other
// i18n-keep common.mobile.settings.boardSyncProgressGeneric_one
// i18n-keep common.mobile.settings.boardSyncProgressGeneric_other
// i18n-keep common.mobile.settings.syncIssuesSection
// i18n-keep common.mobile.settings.deadLetterCount_one
// i18n-keep common.mobile.settings.deadLetterCount_other
// i18n-keep common.mobile.settings.deadLetterSubtitle
// i18n-keep common.mobile.settings.deadLetterRetry
// i18n-keep common.mobile.settings.deadLetterDiscard
// i18n-keep common.mobile.settings.deadLetterDiscardTitle
// i18n-keep common.mobile.settings.deadLetterDiscardMessage
