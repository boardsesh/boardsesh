...
// spinner instead of implying a scan that's no longer running. Transports may
// also supply an AbortSignal when the selection itself has ended outside the
// picker (scan failure, disconnect, or a superseding board/model).
