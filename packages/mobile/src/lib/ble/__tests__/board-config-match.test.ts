...
// classifyClimbBoardCompatibility / findNextCompatibleQueueItem moved to
// @boardsesh/board-config — see packages/shared/board-config/src/__tests__/board-compatibility.test.ts.
