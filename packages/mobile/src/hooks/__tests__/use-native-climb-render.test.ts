...
describe('buildCacheKey', () => {
  ...
  it('uses RENDERER_VERSION v8 to invalidate overlays drawn before the LED base plate landed', () => {
    ...
    // binaries whose drawing was still moving. v8 drops the ones drawn before
...
describe('renderedOverlays warm-up from disk cache', () => {
  ...
  it('only loads PNGs whose name starts with the current RENDERER_VERSION prefix', () => {
    ...
    // v8 entries. The warm-up must surface only v8 keys; every older file is
    // invalid.
