...
/**
 * `/kilter/original/12x12-square/screw_bolt/40/view/crimpy-thing-<uuid>` — the
 * canonical climb URL, shared with the Next app. `/play/<uuid>` is the same
 * destination and differs only in the surface passed below.
 */
export default function BoardClimbViewRoute() {
