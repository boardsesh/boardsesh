...
**AGPL-3.0-or-later** (`LICENSE` in this directory). The rest of
`packages/mobile` is Apache-2.0; this directory, including the prebuilt
binaries, is part of the renderer boundary described in
[`docs/licensing.md`](../../../../docs/licensing.md). Versions of this module
from before the change were offered under Apache-2.0 (the repository licence)
and declared `MIT` in `package.json`, an Expo module template default; those
versions stay available under those terms.
