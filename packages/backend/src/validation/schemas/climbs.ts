...
export const ClimbSearchInputSchema = z.object({
  ...
  // No default: omitted means AURORA, and mapSearchInputToParams collapses an
  // explicit AURORA to undefined so the search-cache key does not change.
  gradeSource: z.enum(['AURORA', 'BOARDSESH']).optional(),
