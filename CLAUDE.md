...
- `docs/spray-walls.md` — spray walls: the identity mapping that makes a wall a runtime-created catalogue layout under the ninth board type (`spray`), the per-wall caps, and the three places spray is deliberately excluded (board pickers, the public snapshot export, sitemaps)
