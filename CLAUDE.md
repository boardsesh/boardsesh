...
- `docs/public-api-rate-limiting.md` — shared 120 req/60s client-IP budget on the ten public `GET /api/v1` routes: identity trust boundary, two-tier memory/Redis enforcement, `REDIS_URL` provisioning for Vercel
